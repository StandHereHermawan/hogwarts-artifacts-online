 ...
 * We implement AuthenticationEntryPoint and then delegate
 * the exception handler to HandlerExceptionResolver.
 *
 * */
@Component
public class CustomBasicAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    /**
     * Here we've injected theDefaultHandlerExceptionResolver and delegated the handler
     * to this resolver.
     * This Security exception now can be handled with controller advice with an
